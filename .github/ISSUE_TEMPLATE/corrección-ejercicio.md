...
Parte 1 - (3,5 puntos) debe contener:
...
Parte 2
(1,5 puntos) Propuesta de nueva arquitectura. La opción más razonable parece ser la escalabilidad horizontal (la mejor) o vertical (solo dimensionando bien la carga). La alternativa de usar un worker no es la ideal porque se responde al request sin que la contraseña se haya cambiado. Se podría utilizar un hook para consultar si la misma se cambió, pero la seguridad se puede ver comprometida.
