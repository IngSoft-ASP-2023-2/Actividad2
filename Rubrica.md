...
## Parte 1
Esta sección (2,5 puntos) debe contener:
- [ ] Dashboard de Elastic Beanstalk
- [ ] Resultados de realizar una solicitud
- [ ] Conexión de New Relic y métricas obtenidas
- [ ] Prueba de carga seleccionada y justificación. Como no se dan datos sobre la cantidad de usuarios concurrentes, la prueba debería ser de estrés para determinar la carga media.
