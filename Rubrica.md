...
## Parte 2 (1,5 puntos)
Propuesta de nueva arquitectura. La opción mas razonable parece ser la escalabilidad horizontal (la mejor) o vertical (solo dimensionando bien la carga). La alternativa de usar un worker no es la ideal porque se responde al request sin que la 
